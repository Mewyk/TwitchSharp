...
/// <summary>Represents a channel prediction lock event.</summary>
public sealed record PredictionLockEvent
{
    ...
    /// <summary>The timestamp when the prediction was locked.</summary>
    [JsonPropertyName("locked_at")]
    public string LockedAt { get; init; } = string.Empty;
}
