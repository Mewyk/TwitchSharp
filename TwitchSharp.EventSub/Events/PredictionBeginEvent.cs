...
/// <summary>Represents a channel prediction begin event.</summary>
public sealed record PredictionBeginEvent
{
    ...
    /// <summary>The possible outcomes for this prediction.</summary>
