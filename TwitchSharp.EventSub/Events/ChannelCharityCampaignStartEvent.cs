...
/// <summary>
/// Represents a channel.charity_campaign.start EventSub event, fired when
/// the broadcaster starts a charity campaign.
/// </summary>
public sealed record ChannelCharityCampaignStartEvent
{
    ...
    /// <summary>The UTC timestamp of when the charity campaign started.</summary>
