...
/// <summary>Represents a channel poll end event.</summary>
public sealed record PollEndEvent
{
    ...
    /// <summary>The poll choices with final vote counts.</summary>
    ...
    /// <summary>The final status of the poll.</summary>
    ...
    /// <summary>The timestamp when the poll ended.</summary>
