...
/// <summary>Represents a fragment within a chat message.</summary>
public sealed record ChatFragmentData
{
    ...
    public ChatFragmentEmoteData? Emote { get; init; }

    /// <summary>The mention data if the fragment is a mention.</summary>
    [JsonPropertyName("mention")]
    public ChatFragmentMentionData? Mention { get; init; }
}
