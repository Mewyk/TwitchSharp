...
/// <summary>Represents a channel hype train begin event (v2).</summary>
public sealed record HypeTrainBeginEvent
{
    ...
    /// <summary>The current progress toward the next level goal.</summary>
    [JsonPropertyName("progress")]
    public int Progress { get; init; }

    /// <summary>The goal required to reach the next level.</summary>
    ...
    /// <summary>The timestamp when the hype train will expire.</summary>
    ...
    /// <summary>The all-time highest level reached on this channel.</summary>
    [JsonPropertyName("all_time_high_level")]
    public int AllTimeHighLevel { get; init; }

    /// <summary>The all-time highest total points reached on this channel.</summary>
    [JsonPropertyName("all_time_high_total")]
    public int AllTimeHighTotal { get; init; }
}
