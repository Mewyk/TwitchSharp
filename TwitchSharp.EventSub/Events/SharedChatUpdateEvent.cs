...
/// <summary>Represents a shared chat session update event.</summary>
public sealed record SharedChatUpdateEvent
{
    ...
    /// <summary>The updated participants in the shared chat session.</summary>
    [JsonPropertyName("participants")]
    public SharedChatParticipantData[] Participants { get; init; } = [];
}
