...
/// <summary>
/// Represents a channel.goal.progress v1 EventSub event, fired when
/// progress is made towards a goal in the specified broadcaster's channel.
/// </summary>
public sealed record ChannelGoalProgressEvent
{
