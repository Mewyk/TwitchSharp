...
/// <summary>
/// Represents a channel.goal.begin v1 EventSub event, fired when the
/// broadcaster creates a new goal in the specified channel.
/// </summary>
public sealed record ChannelGoalBeginEvent
{
